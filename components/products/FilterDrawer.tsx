    ...
    return (
        <>
            ...
            <button
                ...
                className="fixed bottom-6 right-6 z-40 flex items-center gap-2 px-5 py-3 bg-gradient-to-r from-rose via-coral to-gold text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 md:hidden"
            >
